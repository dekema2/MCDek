...
namespace MCLawl
{
    public class CmdInfo : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            {
                Player.SendMessage(p, "This server runs on &aMC&bDek" + Server.DefaultColor + ", which started as MCSharp, and was then continued as MCZall and MCLawl. And now, MCDek aims to bring you the very latest in Nostalgic Classic!");
                ...
                Player.SendMessage(p, "MCDek was founded by dekema2 and 303i, with MinedroidFTW, ballock1, and 3pic_Killz developing the software.");
            }
        }
